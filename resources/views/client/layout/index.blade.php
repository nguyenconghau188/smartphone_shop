...
<html lang="en">
  <head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="client_asset/css/font-awesome.min.css">
  ...
  <body>
    ...
    <script src="client_asset/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="client_asset/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="client_asset/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="client_asset/js/bxslider.min.js"></script>
	<script type="text/javascript" src="client_asset/js/script.slider.js"></script>
    @yield('script')
  </body>
</html>